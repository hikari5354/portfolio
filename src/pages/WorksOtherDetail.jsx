...
const WorksOtherDetail = () => {
  ...
  return (
    <>
      ...
      <article key={workOtherData.id} id="works-detail">
        <div className="first-view jsWorksDetailActive">
          <div className="first-view__txt">
            <TypeText text={workOtherData.activetxt} className="jsTypeWriter" />
          </div>
          <div className="first-view__wrap">
            ...
            <img
              decoding="async"
              src={`../assets/img/works/${workOtherData.imageMain}`}
              alt="制作物のメインイメージです"
              width={workOtherData.MainWidth}
              height={workOtherData.MainHeight}
          ...
          <div className="info">
            ...
            <div className="info__txt-box">
              <ul className="scroll-fadein">
                <li className="bold">
                  {workOtherData.name}
                  <br className="sp-only" /> / {workOtherData.type}
                </li>
                <li>
                  <span>概要</span>
                  <br />
                  {workOtherData.infoDesc}
                </li>
                <li>
                  <span>制作期間</span>
                  <br />
                  {workOtherData.infoPeriod}
                </li>
                <li>
                  <span>使用ツール</span>
                  <br />
                  {workOtherData.infoTool}
                </li>
              </ul>
          ...
          <ol className="process__list">
            <li className="js-active-target">
              <dl>
                ...
                <dd>{workOtherData.process01}</dd>
              </dl>
            </li>
            <li className="js-active-target">
              <dl>
                <dt className="scroll-fadein slideup active">ターゲット</dt>
                <dd>{workOtherData.process02}</dd>
              </dl>
            </li>
            <li className="js-active-target">
              <dl>
                ...
                <dd
                  dangerouslySetInnerHTML={{ __html: workOtherData.process03 }}
                />
              </dl>
            </li>
          </ol>
        ...
        <div className="youtube-link">
          <a href={`//www.youtube.com/watch?v=${workOtherData.youtubeURL}`}>
            <picture>
              <source
                media="(max-width:599px)"
                srcSet={`//i.ytimg.com/vi/${workOtherData.youtubeURL}/hqdefault.jpg 1x, //i.ytimg.com/vi/${workOtherData.youtubeURL}/maxresdefault.jpg 2x`}
                width={480}
                height={360}
              />
              <img
                loading="lazy"
                src={`//i.ytimg.com/vi/${workOtherData.youtubeURL}/maxresdefault.jpg`}
...
export default WorksOtherDetail;
